...
<%
    ...
    String managerUserName = (String)request.getAttribute("managerUserName"); //经理用户名查询关键字
		...
		<div class="col-md-9 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" class="active"><a href="#managerListPanel" aria-controls="managerListPanel" role="tab" data-toggle="tab">部门经理列表</a></li>
			    	<li role="presentation" ><a href="<%=basePath %>Manager/manager_frontAdd.jsp" style="display:none;">添加部门经理</a></li>
				</ul>
			  	<!-- Tab panes -->
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>经理用户名</td><td>所属部门</td><td>姓名</td><td>性别</td><td>出生日期</td><td>联系电话</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
				    	            		...
				    	            		for(int i=0;i<managerList.size();i++) {
					    	            		...
					    	            		Manager manager = managerList.get(i); //获取到部门经理对象
 										%>
 										<tr>
 											<td><%=currentIndex %></td>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="managerQueryForm" id="managerQueryForm" action="<%=basePath %>Manager/frontlist" class="mar_t15">
			<div class="form-group">
				<label for="managerUserName">经理用户名:</label>
				<input type="text" id="managerUserName" name="managerUserName" value="<%=managerUserName %>" class="form-control" placeholder="请输入经理用户名">
			</div>
            ...
            <div class="form-group">
            	<label for="departmentObj_departmentNo">所属部门：</label>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="fa fa-edit"></i>&nbsp;部门经理信息编辑</h4>
      </div>
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
			 <label for="manager_managerUserName_edit" class="col-md-3 text-right">经理用户名:</label>
			 <div class="col-md-9"> 
			 	<input type="text" id="manager_managerUserName_edit" name="manager.managerUserName" class="form-control" placeholder="请输入经理用户名" readOnly>
			 </div>
		  </div> 
		  <div class="form-group">
		  ...
		  <div class="form-group">
		  	 <label for="manager_departmentObj_departmentNo_edit" class="col-md-3 text-right">所属部门:</label>
		  	 <div class="col-md-9">
		  ...
		  <div class="form-group">
		  	 <label for="manager_bornDate_edit" class="col-md-3 text-right">出生日期:</label>
		  	 <div class="col-md-9">
                <div class="input-group date manager_bornDate_edit col-md-12" data-link-field="manager_bornDate_edit"  data-link-format="yyyy-mm-dd">
                    <input class="form-control" id="manager_bornDate_edit" name="manager.bornDate" size="16" type="text" value="" placeholder="请选择出生日期" readonly>
	...
	$.ajax({
		...
		success : function (manager, response, status) {
			if (manager) {
				...
				$("#manager_bornDate_edit").val(manager.bornDate);
...
$(function(){
    ...
    /*出生日期组件*/
    $('.manager_bornDate_edit').datetimepicker({
    	language:  'zh-CN',  //语言
    	format: 'yyyy-mm-dd',
    	minView: 2,
    	weekStart: 1,
