...
<%
    ...
    String salaryYear = (String)request.getAttribute("salaryYear"); //工资年份查询关键字
    String salaryMonth = (String)request.getAttribute("salaryMonth"); //工资月份查询关键字
%>
<!DOCTYPE html>
<html>
<head>
...
<jsp:include page="../header.jsp"></jsp:include>
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>工资id</td><td>员工</td><td>工资年份</td><td>工资月份</td><td>基本工资</td><td>考勤扣除</td><td>实得工资</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
 										...
 										<tr>
 											...
 											<td><%=salary.getBasicWage() %></td>
 											<td><%=salary.getAtttendanceReduce() %></td>
 											<td><%=salary.getRealSalary() %></td>
 											<td>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="salaryQueryForm" id="salaryQueryForm" action="<%=basePath %>Salary/frontlist" class="mar_t15">
			...
			<div class="form-group">
				<label for="salaryYear">工资年份:</label>
				<input type="text" id="salaryYear" name="salaryYear" value="<%=salaryYear %>" class="form-control" placeholder="请输入工资年份">
			</div>
			...
			<div class="form-group">
				...
				<input type="text" id="salaryMonth" name="salaryMonth" value="<%=salaryMonth %>" class="form-control" placeholder="请输入工资月份">
			</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="salary_salaryYear_edit" class="col-md-3 text-right">工资年份:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="salary_salaryYear_edit" name="salary.salaryYear" class="form-control" placeholder="请输入工资年份">
			 </div>
		  </div>
		  <div class="form-group">
		  	 <label for="salary_salaryMonth_edit" class="col-md-3 text-right">工资月份:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="salary_salaryMonth_edit" name="salary.salaryMonth" class="form-control" placeholder="请输入工资月份">
			 </div>
		  </div>
		  <div class="form-group">
		  	 <label for="salary_basicWage_edit" class="col-md-3 text-right">基本工资:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="salary_basicWage_edit" name="salary.basicWage" class="form-control" placeholder="请输入基本工资">
			 </div>
		  </div>
		  <div class="form-group">
		  	 <label for="salary_atttendanceReduce_edit" class="col-md-3 text-right">考勤扣除:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="salary_atttendanceReduce_edit" name="salary.atttendanceReduce" class="form-control" placeholder="请输入考勤扣除">
			 </div>
		  </div>
		  <div class="form-group">
		  	 <label for="salary_realSalary_edit" class="col-md-3 text-right">实得工资:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="salary_realSalary_edit" name="salary.realSalary" class="form-control" placeholder="请输入实得工资">
			 </div>
		  </div>
		</form> 
	...
	$.ajax({
		...
		success : function (salary, response, status) {
			if (salary) {
				...
				$("#salary_salaryYear_edit").val(salary.salaryYear);
				$("#salary_salaryMonth_edit").val(salary.salaryMonth);
				$("#salary_basicWage_edit").val(salary.basicWage);
				$("#salary_atttendanceReduce_edit").val(salary.atttendanceReduce);
				$("#salary_realSalary_edit").val(salary.realSalary);
