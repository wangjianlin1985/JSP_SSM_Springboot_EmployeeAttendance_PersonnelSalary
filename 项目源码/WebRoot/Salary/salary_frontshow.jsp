...
<div class="container">
	...
	<div class="row bottom15"> 
		...
		<div class="col-md-10 col-xs-6"><%=salary.getSalaryYear()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">工资月份:</div>
		<div class="col-md-10 col-xs-6"><%=salary.getSalaryMonth()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">基本工资:</div>
		<div class="col-md-10 col-xs-6"><%=salary.getBasicWage()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">考勤扣除:</div>
		<div class="col-md-10 col-xs-6"><%=salary.getAtttendanceReduce()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">实得工资:</div>
		<div class="col-md-10 col-xs-6"><%=salary.getRealSalary()%></div>
	</div>
	<div class="row bottom15">
