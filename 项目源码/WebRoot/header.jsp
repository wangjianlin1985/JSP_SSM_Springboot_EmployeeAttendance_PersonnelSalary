...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">员工考勤工资系统</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>Manager/frontlist">部门经理</a></li>
                <!--<li><a href="<%=basePath %>LeaveType/frontlist">请假类型</a></li>-->
                <li><a href="<%=basePath %>LeaveInfo/frontlist">请假信息</a></li>
                <!--<li><a href="<%=basePath %>AttendanceState/frontlist">出勤状态</a></li>-->
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        <li><a href="<%=basePath %>LeaveInfo/leaveInfo_frontEmpAdd.jsp"><span class="glyphicon glyphicon-screenshot"></span>&nbsp;&nbsp;我要请假</a></li>
                        <li><a href="<%=basePath %>LeaveInfo/empFrontlist"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;我的请假信息</a></li>
                        <li><a href="<%=basePath %>Attendance/empFrontlist"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我的出勤信息</a></li>
                        <li><a href="<%=basePath %>Salary/empFrontlist"><span class="glyphicon glyphicon-heart"></span>&nbsp;&nbsp;我的工资信息</a></li>
