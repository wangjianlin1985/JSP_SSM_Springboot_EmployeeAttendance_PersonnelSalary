  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="employee_employeePhoto_edit" class="col-md-3 text-right">用户照片:</label>
		  	 <div class="col-md-9">
		  ...
		  <div class="form-group">
		  	 <label for="employee_basicWage_edit" class="col-md-3 text-right">基本工资:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="employee_basicWage_edit" name="employee.basicWage" class="form-control" placeholder="请输入基本工资">
			 </div>
		  </div>
		  <div class="form-group">
	...
	$.ajax({
		...
		success : function (employee, response, status) {
			if (employee) {
				...
				$("#employee_basicWage_edit").val(employee.basicWage);
